...
software="which git diff ping fzf curl jq nc ssh-copy-id  ssh-keygen awk sed" #ponemos el foftware a instalar separado por espacion dentro de las comillas ( soft1 soft2 soft3 etc )
